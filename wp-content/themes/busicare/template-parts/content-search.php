<article id="post-<?php the_ID(); ?>" <?php post_class('post'); ?>>	
	...
	<div class="entry-content">
		...
		<p><a href = "'.esc_url(get_the_permalink()).'" class="more-link"><?php echo esc_html__( 'Read More','busicare' );?><i class="fa <?php if(is_rtl()){echo 'fa-long-arrow-left';} else{ echo 'fa-long-arrow-right';}?>"></i></a></p>
	</div>										
</article>