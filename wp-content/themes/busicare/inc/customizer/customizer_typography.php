...
// Enable/Disable Section title typography section
    ...
    $wp_customize->add_control('enable_section_title_typography', array(
        'label' => esc_html__('Enable typography, this setting works only for Section Title and Description on page templates like homepage, about, service, and portfolio (2 column, 3 column and 4 column)', 'busicare'),
...
// Enable/Disable Footer Widgets typography section
    ...
    $wp_customize->add_control('enable_footer_widget_typography', array(
        'label' => esc_html__('Enable Footer Widget typography', 'busicare'),
